...
class Countdown {
    ...
    //function defined in the countdown object
    //runs the timer
    run() {
       ...
       let countdown = setInterval(_ => {
        //get latest time
          ...
          //Do some math so that we can understand it
          ...
          //When timer is at 100% stop the countdown with a clear interval
     ...
     // TO DO NEXT STEP 
    //define a reset function here, inside the Countdown class
  //    reset(){}}
 ...
 // })
  //  function resetCountDownBut(){
    //Understand how this timer works in JS, so that we can manipulate it here
    //TODO figure out how this timer starts

    //TODO figure out how to stoope it
